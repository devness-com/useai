...
import type { Filters } from '@useai/ui';
import { SessionList } from '@useai/ui';
...
export function SearchOverlay({ open, onClose, sessions, milestones, deleteSession, deleteConversation, deleteMilestone }: SearchOverlayProps) {
